...
class utils {
	...
	public static function get_shortcodes_uri( $shortcode_name, $path = '' ) {
		return \Trends()->config['shortcodes_uri'] . '/' . $shortcode_name . '/' . $path;
	}
	
	public static function get_shortcodes_dir( $shortcode_name, $path = '' ) {
		return \Trends()->config['shortcodes_dir'] . '/' . $shortcode_name . '/' . $path;
	}
	...
	public static function get_widgets_uri( $widget_name, $path = '' ) {
		return \Trends()->config['widgets_uri'] . '/' . $widget_name . '/' . $path;
	}
	...
	public static function get_social_cfg_usyon() {
		...
		foreach ( \Trends()->config['social_profiles'] as $k => $v ) {
			$config[ $k ] = array(
				'type'  => 'text',
				'label' => $v,
				'value' => ''
