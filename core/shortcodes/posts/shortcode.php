...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	...
	class WPBakeryShortCode_Posts extends WPBakeryShortCode {
		...
		protected function content( $atts, $content = null ) {
			...
			// query posts
			$posts_query = Trends()->model->post->get_posts( $atts );
			...
			wp_register_script( 'shortcode-posts', $shortcode_uri . '/assets/scripts.js', array( 'jquery' ), Trends()->config['cache_time'], true );
