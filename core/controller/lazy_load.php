...
class lazy_load {
	...
	function skip() {
		...
		$is_img_lazy_load_enabled = (int)\trends\helper\utils::get_option( 'img_lazy_load', 1 );
	...
	function load_assets() {
		wp_enqueue_script( 'trends-lazy-load-images', Trends()->config['assets_uri'] . 'js/lazyload.js', array(), Trends()->config['cache_time'], false );
		wp_script_add_data( 'trends-lazy-load-images', 'defer', true );
	}
