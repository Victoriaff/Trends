...
class backend {
	...
	function load_assets() {
		wp_enqueue_style( 'fruitfulblankprefix-backend', get_template_directory_uri() . '/assets/css/admin/admin.css', false, Trends()->config['cache_time'] );
	}
	...
	function add_theme_options_menu( $data ) {
		...
		add_theme_page(
			esc_html__( 'Website Settings', 'trends' ),
			esc_html__( 'Website Settings', 'trends' ),
			$data['capability'],
			$data['slug'],
