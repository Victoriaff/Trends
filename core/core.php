...
use trends\helper\utils;
use trends\model\database;
use trends\view\view;
...
class core {
	...
	public function run() {
		...
		// Translation support
		load_theme_textdomain( 'trends', get_template_directory() . '/languages' );
